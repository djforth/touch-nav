...
var Touch = (function (_React$Component) {
  ...
  function Touch(props) {
    ...
    _this.pos = 0;
    _this.state = { listWidth: 1000, listPos: 0, id: id, navitems: NavStore.getNavItems(id) };
    return _this;
  }
  ...
  _createClass(Touch, [{
    ...
    value: function _mover(dir) {
      ...
      var holder = _.get(this.refs, 'holder').offsetWidth;
    ...
    value: function _renderNav() {
      ...
      if (_.isArray(this.state.navitems)) {
        navitems = _.map(this.state.navitems, function (ni, i) {
          var key = _this2.createId(ni.name, i);
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(
          "a",
          { href: "#", className: "nav-mover move-left", onClick: this._buttonMove.bind(this, "left") },
          React.createElement(
            "span",
            { className: "hidden" },
            "left"
        ...
        React.createElement(
          "div",
          { className: "list-holder", ref: "holder" },
          React.createElement(
            "ul",
            { className: "nav-items", style: this._setStyle(), onLoad: this._getWidths.bind(this) },
            this._renderNav()
          )
        ),
        React.createElement(
          "a",
          { href: "#", className: "nav-mover move-right", onClick: this._buttonMove.bind(this, "right") },
          React.createElement(
            "span",
            { className: "hidden" },
            "right"
