...
var Touch = (function (_React$Component) {
  ...
  function Touch(props) {
    ...
    _this.pos = 0;
    _this.state = { listWidth: 1000, listPos: 0, id: id, navitems: NavStore.getNavItems(id), left: _this.getClasses(_this.left), right: _this.getClasses(_this.right), showBtn: true };
    return _this;
  }
