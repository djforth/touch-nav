...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(Dispatcher, "Dispatcher", "src/dispatchers/nav_dispatcher.js");

  __REACT_HOT_LOADER__.register(NavDispatcher, "NavDispatcher", "src/dispatchers/nav_dispatcher.js");
}();
