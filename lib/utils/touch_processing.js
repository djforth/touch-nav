(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['module', 'exports', 'lodash/first'], factory);
  } else if (typeof exports !== "undefined") {
    factory(module, exports, require('lodash/first'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod, mod.exports, global.first);
    global.touch_processing = mod.exports;
  }
})(this, function (module, exports, _first2) {
  'use strict';
  ...
  exports.default = function (touches) {
    var sensitivity = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 10;

    var start = (0, _first3.default)(touches);
    ...
    return {
      addMove: function addMove(touches) {
        move = (0, _first3.default)(touches);
      },
      getDirection: function getDirection() {
        var _getXY3 = getXY(move),
            _getXY4 = _slicedToArray(_getXY3, 2),
            endX = _getXY4[0],
            endY = _getXY4[1];
