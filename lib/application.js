...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(test, "test", "src/application.js");

  __REACT_HOT_LOADER__.register(createConfigs, "createConfigs", "src/application.js");

  __REACT_HOT_LOADER__.register(addNavs, "addNavs", "src/application.js");

  __REACT_HOT_LOADER__.register(callback, "callback", "src/application.js");

  __REACT_HOT_LOADER__.register(link, "link", "src/application.js");
}();
